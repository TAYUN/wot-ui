<template>
  <page-wraper>
    ...
    <demo-block title="半选状态">
      <wd-checkbox v-model="check" @change="indeterminate = false" :indeterminate="indeterminate">半选状态</wd-checkbox>
    </demo-block>
    ...
    <demo-block :title="$t('she-zhi-zui-xiao-xuan-zhong-shu-liang-he-zui-da-xuan-zhong-shu-liang')">
